...
public class C01_StringManupulation {
     ...
     */
       ...
       3) \\s   ==> space tum bosluklar space
        ...
        System.out.println("Yuz"+(40+60));//yuz100    parantez önceligi
        System.out.println("ikiyuzkirk"+40*6);//ikiyuzkirk240   carpmanin önceligi
        System.out.println(60+40+"Yuz");//100Yuz  soldan saga yazar java


       //kullanicidan ismini soy ismini girmesini isteyin
        ...
        //verilen cumkeyi * ile gizleyip 10.karakterden sonrasini ekleyip yazdirin
        String cumle = "her dert Java gibi olsa";
        System.out.println(cumle.replaceAll("\\w","*")+cumle.substring(10));*/

        //a harfini @ isareti ile degisti
